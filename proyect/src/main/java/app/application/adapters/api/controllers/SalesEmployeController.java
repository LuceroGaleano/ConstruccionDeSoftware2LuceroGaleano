...
public class SalesEmployeController {
    ...
    public SalesEmployeController(SalesEmployeUseCase salesEmployeUseCase) {
    ...
    public ResponseEntity<LoanResponse> createLoan(
        ...
        salesEmployeUseCase.createLoan(loan);
    ...
    public ResponseEntity<BankAccountResponse> createBankAccount(
        ...
        salesEmployeUseCase.createBankAccount(bankAccount);
